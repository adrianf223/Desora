...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment_es6__ = __webpack_require__(2);
	...
	constructor() {
		...
		(function actualizare() {
			...
			if (secundeDeScurs > 0) {
				...
				try {
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#sunatoare')[0].play();
				} catch (e) {}
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.buton-setare').click(function () {
			...
			__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON(alarmeData, function (data) {
				...
				__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.sterge-linie').click(function (rand) {
				...
				__WEBPACK_IMPORTED_MODULE_0_jquery___default()("table tr").click(function (rand) {
					...
					// $("#id").val(id);
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#ore").val(ore);
		...
		msgSetareAlarma.click(function (element) {
			...
			if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(element.target).is('panou-alarma')) {
...
class Ceas {
    constructor() {
        this.ceas = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#ceas');
    ...
    adaugaSegmente() {
        ...
        for (let index in this.pozitii) {
            if (this.pozitii[index] == ':') {
                ...
                let locIndicator = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>');
    ...
    adaugaZileleSaptamanii() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(numeZile, function (index, nume) {
    ...
    actualizareEcran() {
        ...
        let acum = __WEBPACK_IMPORTED_MODULE_1_moment_es6___default()().format("hhmmssdA");
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Ceas;
